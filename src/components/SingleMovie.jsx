  ...
  return (
    <section className="w-[164px] sm:w-[220px] lg:w-[280px]">
      <div className="relative w-[164px] h-[110px] rounded-lg overflow-hidden bg-cover bg-no-repeat sm:w-[220px] sm:h-[140px] lg:w-[280px] lg:h-[174px] group/item">
        ...
        <button
          className="bg-primary-black opacity-60 w-8 h-8 absolute top-2 right-2 rounded-full hover:cursor-pointer transition duration-300 ease-in-out flex items-center justify-center sm:top-4 sm:right-4"
